...
<script>
    ...
    function createItem() {
        ...
        $('#ModalManage .modal-body').load("{{ route('stamping.create') }}");
        $('#ModalManage').modal('show');
    }

    function updateItem(id) {
        $('#ModalManage .modal-body').html("");
        $('#ModalManage .modal-body').load("{{ route('stamping.create') }}/" + id);
        $('#ModalManage').modal('show');
    }
