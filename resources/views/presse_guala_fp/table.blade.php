...
<script>
    ...
    function loadGridData() {
        fetch("{{ route('presse_guala_fp.json') }}", {
            method: 'POST',
            headers: {
    ...
    function createItem() {
        ...
        $('#ModalManage .modal-body').load("{{ route('presse_guala_fp.create') }}");
        $('#ModalManage').modal('show');
    }

    function updateItem(id) {
        $('#ModalManage .modal-body').html("");
        $('#ModalManage .modal-body').load("{{ route('presse_guala_fp.create') }}/" + id);
        $('#ModalManage').modal('show');
    }
    ...
    function deleteItem(id) {
        Swal.fire({
            ...
            if (result.isConfirmed) {
                $.post("{{ route('presse_guala_fp.destroy') }}", {
                    id_to_del: id,
                    _token: "{{ csrf_token() }}"
                }).done(function () {
                    loadGridData();
