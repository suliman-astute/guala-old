...
<script>
    ...
    function createItem() {
        ...
        $('#ModalManage .modal-body').load("{{ route('macchine.create') }}");
        $('#ModalManage').modal('show');
    }

    function updateItem(id) {
        $('#ModalManage .modal-body').html("");
        $('#ModalManage .modal-body').load("{{ route('macchine.create') }}/" + id);
        $('#ModalManage').modal('show');
    }
