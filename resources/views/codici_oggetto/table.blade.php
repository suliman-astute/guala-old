...
<script>
    ...
    function loadGridData() {
        fetch("{{ route('codice_oggetto.json') }}", {
            method: 'POST',
            headers: {
    ...
    function createItem() {
        ...
        $('#ModalManage .modal-body').load("{{ route('codice_oggetto.create') }}");
        $('#ModalManage').modal('show');
    }

    function updateItem(id) {
        $('#ModalManage .modal-body').html("");
        $('#ModalManage .modal-body').load("{{ route('codice_oggetto.create') }}/" + id);
        $('#ModalManage').modal('show');
    }
